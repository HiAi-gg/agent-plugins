...
your client's plugin install flow. No build step is required. Complete OAuth in
your client on first connect (or configure an API token at the client level).
