...
| Known limitations | Requires CLI install in the agent environment; browser binary downloaded on first `install` |
| Verification date | 2026-08-07 |

Runtime verification: `RUNTIME_VERIFIED` — doctor, open, read, click, fill,
navigate, read, close all executed successfully with 0.31.1.
