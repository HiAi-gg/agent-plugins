...
- Skills: `inspect-docker-environment`, `diagnose-container`,
  `diagnose-compose`, `review-dockerfile`.
- Skills-only architecture (no MCP) documented.
- Read-only default posture; destructive operations gated behind user intent.
