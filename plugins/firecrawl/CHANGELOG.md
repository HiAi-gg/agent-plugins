...
- MCP server `firecrawl` (stdio, `firecrawl-mcp@3.23.4`, pinned).
- Skills: `research-web`, `scrape-page`, `crawl-site`,
  `extract-structured-data`.
- Keyless default (no API key bundled); key documented as optional client-level
  config for crawl/extract.
